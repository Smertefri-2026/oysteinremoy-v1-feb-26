      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
        ...
        <div className="space-y-3 order-1 lg:order-1">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight">
            Bedre ledelse i praksis
          </h2>

          <p className="text-muted max-w-prose">
            Tydelige forventninger, trygghet og gjennomføring – uten å bli hard. Passer for ledere,
            mellomledere og gründere.
          </p>
          ...
          <div className="w-full max-w-100">
            <div className="rounded-2xl border border-[rgba(2,6,23,0.10)] bg-[#F3E8DA] p-3 shadow-sm">
              <div className="relative aspect-4/3 overflow-hidden rounded-xl">
                <Image src="/kurs/oystein-remoy-ledelse.jpg" alt="Kurs i ledelse" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
