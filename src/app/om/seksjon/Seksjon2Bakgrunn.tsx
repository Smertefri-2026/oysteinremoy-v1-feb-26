...
export default function Seksjon2Bakgrunn() {
  ...
  return (
    <section className="grid gap-6 md:grid-cols-2 md:items-center">
      {/* MEDIA først i DOM => alltid øverst på mobil */}
      <div className="media-frame md:order-2">
      ...
      <div className="space-y-4 md:order-1">
        ...
        <p className="text-muted max-w-prose">
          Jeg er født i Ørsta på Sunnmøre, i en stor fiskerfamilie der verdien av ansvar,
          drift og gjennomføring har vært tydelig i generasjoner.
        </p>
